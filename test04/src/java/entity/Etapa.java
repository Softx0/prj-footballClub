...
@NamedQueries({
    ...
    , @NamedQuery(name = "Etapa.findByFKIdCopa", query = "SELECT e FROM Etapa e WHERE e.fKIdCopa = :fKIdCopa")})
public class Etapa implements Serializable {
    ...
    @Column(name = "FK_IdCopa")
    private Integer fKIdCopa;
    ...
    public Integer getFKIdCopa() {
        return fKIdCopa;
    }

    public void setFKIdCopa(Integer fKIdCopa) {
        this.fKIdCopa = fKIdCopa;
    }
